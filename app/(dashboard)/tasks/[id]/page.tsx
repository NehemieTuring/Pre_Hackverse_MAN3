...
import {
  ...
  Zap, CircleDashed, Play, Pause, Square, RotateCcw, Lightbulb,
  AlertTriangle, Info,
} from "lucide-react";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 20 }}>
              <h1 style={{ fontSize: 28, fontWeight: 900, letterSpacing: "-0.04em", margin: 0, color: "var(--foreground)", flex: 1 }}>
                {task.title}
              </h1>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              {task.dueDate && (
                <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 14px", borderRadius: 11, background: "var(--background)", border: "1px solid var(--card-border)" }}>
                  <Calendar size={14} color="#60a5fa" />
                  <div>
                    <p style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--muted)", margin: 0 }}>Échéance</p>
          ...
          <div style={{
            ...
            <h3 style={{ fontWeight: 800, fontSize: 15, margin: "0 0 14px", color: "var(--foreground)" }}>Description</h3>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
              ...
              <h3 style={{ fontWeight: 800, fontSize: 14, margin: 0, color: "var(--accent)" }}>Conseil Intelligent</h3>
            </div>
            <p style={{ fontSize: 13, color: "var(--muted)", lineHeight: 1.65, margin: 0, fontWeight: 500 }}>
